...
config :azimutt,
  ...
  pro_plan_seat_price: 1000,
  free_plan_seats: 1000,
  # MUST stay in sync with frontend/src/Conf.elm (`features`)
  free_plan_layouts: 1000,
  free_plan_memos: 10000,
  free_plan_groups: 10,
  free_plan_colors: true,
  free_plan_private_links: true,
  free_plan_sql_export: true,
  free_plan_db_analysis: true,
  free_plan_db_access: true,
